...
constexpr std::array<const char *, kTextCount> kTextEs = {{
    ...
    "Mapa general H700", "Navegar por la estanteria; pasar pagina o desplazar en lectura",
...
constexpr std::array<const char *, kTextCount> kTextFr = {{
    ...
    "Profil H700 standard", "Parcourir la bibliotheque; tourner ou faire defiler en lecture",
...
constexpr std::array<const char *, kTextCount> kTextDe = {{
    ...
    "H700 Standardbelegung", "Im Regal navigieren; beim Lesen blattern oder scrollen",
...
constexpr std::array<const char *, kTextCount> kTextJa = {{
    ...
    u8"34XX SP\u5c02\u7528\u30de\u30c3\u30d4\u30f3\u30b0", u8"H700\u6a19\u6e96\u30de\u30c3\u30d4\u30f3\u30b0",
...
constexpr std::array<const char *, kTextCount> kTextKo = {{
    ...
    u8"34XX SP \uc804\uc6a9 \ub9e4\ud551", u8"H700 \uae30\ubcf8 \ub9e4\ud551",
...
constexpr std::array<const char *, kTextCount> kTextAr = {{
    ...
    u8"\u062a\u062e\u0637\u064a\u0637 34XX SP", u8"\u062a\u062e\u0637\u064a\u0637 H700 \u0627\u0644\u0639\u0627\u0645",
...
constexpr std::array<const char *, kTextCount> kTextRu = {{
    ...
    u8"\u0420\u0430\u0441\u043a\u043b\u0430\u0434\u043a\u0430 34XX SP", u8"\u0421\u0442\u0430\u043d\u0434\u0430\u0440\u0442\u043d\u0430\u044f \u0440\u0430\u0441\u043a\u043b\u0430\u0434\u043a\u0430 H700",
...
constexpr std::array<const char *, kTextCount> kTextVi = {{
    ...
    u8"S\u01a1 \u0111\u1ed3 34XX SP", u8"S\u01a1 \u0111\u1ed3 H700 ti\u00eau chu\u1ea9n",
